...
values(nextval('PROJECT_SEQ'), 'Modernising the building', 'Mechelen', 'We modernise our building to bring us up to date with the standards of the future', true, 20, 'https://i.imgur.com/IyW8V33.png', 1);

insert into PROJECT (ID, PROJECT_NAME, CITY, INFO, INTERNAL, LENGTH_IN_DAYS, IMAGE_URL, leader_id)
values(nextval('PROJECT_SEQ'), 'Improving work efficiency', 'Heist-op-den-berg', 'Improving the work efficiency for a client in Heist', false, 60, 'https://i.imgur.com/B2k3626.png', 2);

insert into PROJECT (ID, PROJECT_NAME, CITY, INFO, INTERNAL, LENGTH_IN_DAYS, IMAGE_URL, leader_id)
values(nextval('PROJECT_SEQ'), 'Removing excess data', 'Mechelen', 'We remove excess data from our servers to make our support faster and more responsive', true, 10, 'https://i.imgur.com/Ez8mb9x.png', 2);

insert into PROJECT (ID, PROJECT_NAME, CITY, INFO, INTERNAL, LENGTH_IN_DAYS, IMAGE_URL, LEADER_ID)
values(nextval('PROJECT_SEQ'), 'Making an app', 'Mechelen', 'Making an app to reach out to our clients and make it easier to contact us for ideas', true, 90, 'https://i.imgur.com/6GskHfK.png',3);
